...
"""autogenerated by genpy from rmep_msgs/RobotArmRequest.msg. Do not edit."""
import codecs
import sys
...
class RobotArmRequest(genpy.Message):
  ...
  _type = "rmep_msgs/RobotArmRequest"
...
def _get_struct_2f():
    ...
    return _struct_2f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rmep_msgs/RobotArmResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class RobotArmResponse(genpy.Message):
  ...
  _type = "rmep_msgs/RobotArmResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class RobotArm(object):
  _type          = 'rmep_msgs/RobotArm'
  _md5sum = 'ca73bd755846e340fdd096df095b3706'
